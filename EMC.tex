...
\paragraph{}The MARATHON experiment will provide DIS data to determine the EMC effect for the two A=3 mirror nuclei. Previous experiments to measure the $^3$He EMC ratios where able to gather data at low and medium $x$ for DIS kinematics, and data in the resonance region for higher $x$. The data gather from this experiment will provided the first DIS data in the high $x$ region. The DIS data on $^3$H will be able to provide the first ever measurement of the EMC effect for $^3$H covering a large range of $x$ from 0.2 to 0.8.
