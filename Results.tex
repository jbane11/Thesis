...
%\pagebreak
%\thispagestyle{lscape}
%\newgeometry{   left = 1.5in,right = 1.0in,top = 1.0in,bottom = 1.375in}
%\pagestyle{lscape}
%\begin{landscape}
\begin{figure}[t]
%	\vspace*{-2.75cm}
	\centering
	\includegraphics[width=13.5cm]{../images/total_xs.pdf}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=13.5cm]{../images/A_D_ratios.pdf}
