...
\end{figure}
I show the comparison between data and Monte Carlo in bins of $x$ for cross section extraction in figure \ref{D_MC_COMP}. This ratio factor will be applied to the model cross section to extract the measured cross section. I will discuss the cross section results and their uncertainties in the next section. 
