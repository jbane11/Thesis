...
\begin{figure}[h]
	...
	{\centering
	\hspace{-10pt}
	\includegraphics[height=7.75cm,width=7.75cm]{dp_ytar_1207.eps}
	\includegraphics[height=7.75cm,width=7.75cm]{xp_yp_tar_1207.eps}
}
\end{figure}
\begin{figure}[H]
