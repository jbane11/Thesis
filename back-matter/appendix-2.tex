...
\begin{figure}[p!]
  ...
  \includegraphics[width=7cm]{Initial.png}
  \label{IV}}
  \quad
  \centering
  \subfloat[Rotated by Lambda]{
  \includegraphics[width=7cm]{RotatedbyLam.png}
  \label{LAM}}
  \vspace{0.25cm}
  \centering
  \subfloat[Boosted]{
  \includegraphics[width=7cm]{boosted.png}
  \label{boost}}
  \quad
  \centering
  \subfloat[Before being scattered]{
  \includegraphics[width=7cm]{beforescattering.png}
  \label{delta}}
   \vspace{0.25cm} 
...
\begin{figure}[t!]
\centering
\includegraphics[width=13cm]{Es_results.png}
