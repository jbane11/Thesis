...
%\begin{figure}[]
%	\centering
%	\includegraphics[width=8cm]{F2p_At82.pdf} 	\caption{ Measurement of the proton structure function $F_2(x, Q^2)$ for a range of $Q^2$ values \cite{Atwood}.}
%	\label{F2_At_fig}
%\end{figure} 
...
\begin{figure}[]
%	\hspace*{-20pt}
	\includegraphics[width=8cm]{F2_HERA.pdf} 
...
\begin{figure}[]
%	\vspace*{-30pt}
	\includegraphics[width=7.5cm]{q2indy.pdf} 
