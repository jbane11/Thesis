...
\subsection{Injector}
	...
	\begin{figure}[t]
	\centering
	\includegraphics[width=10cm]{injector.pdf} 
...
\begin{figure}[t]
	%	\hspace*{-2cm} 
	\centering
	\includegraphics[width=12.5cm]{trigger_layout.pdf}
